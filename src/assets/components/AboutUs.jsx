  ...
  const cards = [
    {
      ...
      description: "Our videos ensures that your message is conveyed effectively and resonates with your audience."
    },
    {
      imgSrc: Id,
    ...
    <section className="about-us flex flex-col items-center py-10"style={{paddingTop:'7rem'}}>
      ...
      <div className="bg-gray-100 p-10 rounded-lg w-full flex flex-col items-center justify-center"style={{height:'70vh'}}>
        <div className="Monsterrat max-w-3xl text-center mb-12">
          <p className="Monsterrat text-lg">
        ...
        <div className="flex flex-wrap justify-center gap-20">
          {cards.map((card, index) => (
            <div key={index} className="box relative w-64 h-40">
              ...
              <div className="box-back absolute w-full h-full shadow-xl backface-hidden transform rotate-y-180 transition-transform duration-200 flex flex-col items-center justify-center bg-accent p-4 border border-gray-300 rounded-lg" style={{width:'120%',height:'120%'}}>
