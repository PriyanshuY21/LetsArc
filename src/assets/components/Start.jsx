...
const Start = () => {
  return (
    <section className="about-us flex flex-col items-center py-10" style={{ paddingTop: '7rem' }}>
      <h2 className="text-5xl md:text-3xl font-bold mb-8 text-cl" style={{ paddingBottom: '7rem' }}>Start Now</h2>
      <div className="bg-gray-50 shadow-lg p-6 md:p-10 rounded-lg w-full flex flex-col items-center justify-center h-[70vh] md:h-auto sm:h-[40vh]">
